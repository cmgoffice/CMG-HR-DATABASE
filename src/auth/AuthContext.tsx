...
export type UserRole = "MasterAdmin" | "MD" | "GM" | "PD" | "PM" | "CM" | "HRM" | "HR" | "Admin Site" | "Safety" | "Staff" | "Foreman";

export const ALL_ROLES: UserRole[] = ["MasterAdmin", "MD", "GM", "PD", "PM", "CM", "HRM", "HR", "Admin Site", "Safety", "Staff", "Foreman"];
